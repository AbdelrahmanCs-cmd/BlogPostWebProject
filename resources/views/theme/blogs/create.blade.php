...
@section('content')
    @include('theme.partialThemes.hero', ['title' => 'Add New Blog'])
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="{{ route('blogs.store') }}" class="form-contact contact_form" method="post"
                        ...
                        <div class="form-group">
                            <textarea class="w-100 border" name="content" placeholder="Enter your blog title" rows="5">{{ old('content') }}</textarea>
